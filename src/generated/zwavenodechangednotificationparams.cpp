...
ZWaveNodeChangedNotificationParams ZWaveNodeChangedNotificationParams::fromJson(const QJsonObject &object) {
...
QJsonObject ZWaveNodeChangedNotificationParams::toJson() const {
    QJsonObject object;
