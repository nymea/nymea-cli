...
NetworkManagerWiredNetworkDeviceChangedNotificationParams NetworkManagerWiredNetworkDeviceChangedNotificationParams::fromJson(const QJsonObject &object) {
...
QJsonObject NetworkManagerWiredNetworkDeviceChangedNotificationParams::toJson() const {
    QJsonObject object;
